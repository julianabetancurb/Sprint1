...
namespace Sprint1.Controllers
{
    ...
    {
        private readonly Sprint1Context _context;

        public ConvocatoriasController(Sprint1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Convocatoria != null ? 
                          ...
                          Problem("Entity set 'Sprint1Context.Convocatoria'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Sprint1Context.Convocatoria'  is null.");
            }
            var convocatoria = await _context.Convocatoria.FindAsync(id);
            if (convocatoria != null)
            {
